    ...
    executeCommand(context) {
        ...
        if (context.activeRace.teams && !context.activeRace.relay) {
            ...
            if (allDone) {
                ...
                this._app.sendToDiscordRaceChannel(`<@${nextMember.id}> ${player.username} has finished. You will be able to start your leg of the relay in ${(this._app.config['relayLegDelaySeconds'] + this._app.config['relayForfeitDelaySeconds']) / 60} minutes.`);
            }
        }
